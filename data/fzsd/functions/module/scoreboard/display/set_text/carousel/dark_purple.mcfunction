...
data modify storage fzsd:module fzsd.module.scoreboard.text.carousel set value '{"text": "輪播", "color": "dark_purple"}'
team modify fzsd.module.scoreboard.display.carousel color dark_purple
team modify fzsd.module.scoreboard.display.carousel displayName {"text": "輪播", "color": "dark_purple"}
