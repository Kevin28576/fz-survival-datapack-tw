...
data modify storage fzsd:module fzsd.module.scoreboard.text.carousel set value '{"text": "輪播", "color": "gold"}'
team modify fzsd.module.scoreboard.display.carousel color gold
team modify fzsd.module.scoreboard.display.carousel displayName {"text": "輪播", "color": "gold"}
